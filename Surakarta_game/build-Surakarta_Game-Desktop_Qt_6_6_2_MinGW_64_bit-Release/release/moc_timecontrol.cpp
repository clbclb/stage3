/****************************************************************************
** Meta object code from reading C++ file 'timecontrol.h'
**
...
#include "../../Surakarta_Game/timecontrol.h"
...
#error "The header file 'timecontrol.h' doesn't include <QObject>."
...
Q_CONSTINIT static const qt_meta_stringdata_CLASStimecontrolENDCLASS_t qt_meta_stringdata_CLASStimecontrolENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 11),  // "freshSignal"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 1),  // "s"
        QT_MOC_LITERAL(27, 12)   // "on_timer_out"
    },
    "timecontrol",
    "freshSignal",
    "",
...
void timecontrol::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->freshSignal((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->on_timer_out(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (timecontrol::*)(int );
            if (_t _q_method = &timecontrol::freshSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void timecontrol::freshSignal(int _t1)
{
