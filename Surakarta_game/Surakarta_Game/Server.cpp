...
bool Server::judgemove(int frx,int fry,int tx,int ty){
    ...
    if(current_player=="WHITE"&&color[frx][fry]==PieceColor::BLACK)return 0;
    if(current_player=="BLACK"&&color[frx][fry]==PieceColor::WHITE)return 0;
...
bool Server::check(int x,int y,int dir,int dep,int edx,int edy,bool bk){
